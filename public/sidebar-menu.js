var VueSidebarMenu = (function (exports, vue) {
  "use strict";
  ...
  function activeRecordIndex(route, currentRoute) {
    ...
    var index = currentMatched.findIndex(
  ...
  function useItem(props) {
    ...
    var linkClass = vue.computed(function () {
      return [
        "vsm--link",
        "vsm--link_level-".concat(props.level),
        {
    ...
    var isMobileItem = vue.computed(function () {
      ...
      return (
        props.item.id ===
        ((_mobileItem$value = mobileItem.value) === null ||
        _mobileItem$value === void 0
          ? void 0
          : _mobileItem$value.id)
      );
    });
    ...
    var mobileItemBackgroundStyle = vue.computed(function () {
      return [
        ...
        {
          width: "".concat(
            mobileItemRect.value.maxWidth +
              parseInt(sidebarProps.widthCollapsed),
            "px"
          ),
        },
        {
    ...
    return $options.isHyperLink
      ? (vue.openBlock(),
        vue.createElementBlock(
          "a",
          vue.normalizeProps(vue.mergeProps({ key: 0 }, _ctx.$attrs)),
    ...
    return (
      ...
      vue.createBlock(
        vue.resolveDynamicComponent(
          $props.icon.element ? $props.icon.element : "i"
        ),
        vue.mergeProps(
          {
            class: [
              "vsm--icon",
              typeof $props.icon === "string" || $props.icon instanceof String
                ? $props.icon
                : $props.icon.class,
            ],
            "aria-hidden": "true",
        ...
        ),
        {
          default: vue.withCtx(() => [
            vue.createTextVNode(
              vue.toDisplayString($props.icon.text),
              1 /* TEXT */
            ),
          ]),
          _: 1 /* STABLE */,
  ...
  function render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      ...
      vue.createBlock(
        vue.resolveDynamicComponent(
          $props.badge.element ? $props.badge.element : "span"
        ),
        vue.mergeProps(
          {
        ...
        ),
        {
          default: vue.withCtx(() => [
            vue.createTextVNode(
              vue.toDisplayString($props.badge.text),
              1 /* TEXT */
            ),
          ]),
          _: 1 /* STABLE */,
  ...
  function render$2(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_sidebar_menu_icon =
      vue.resolveComponent("sidebar-menu-icon");
    const _component_sidebar_menu_badge =
      vue.resolveComponent("sidebar-menu-badge");
    const _component_sidebar_menu_item = vue.resolveComponent(
      "sidebar-menu-item",
      true
    );
    ...
    return $props.item.component && !$setup.isHidden
      ? (vue.openBlock(),
        vue.createElementBlock("li", _hoisted_1$2, [
          (vue.openBlock(),
          vue.createBlock(
            vue.resolveDynamicComponent($props.item.component),
            vue.normalizeProps(vue.guardReactiveProps($props.item.props)),
            null,
            16 /* FULL_PROPS */
          )),
        ]))
      ...
      ? (vue.openBlock(),
        vue.createElementBlock(
          ...
          vue.toDisplayString($props.item.header),
          17 /* TEXT, FULL_PROPS */
        ))
      : !$setup.isHidden
      ? (vue.openBlock(),
          ...
          vue.mergeProps(
            {
              ...
              onMouseover:
                _cache[0] ||
                (_cache[0] = (...args) =>
                  $setup.onMouseOver && $setup.onMouseOver(...args)),
              onMouseout:
                _cache[1] ||
                (_cache[1] = (...args) =>
                  $setup.onMouseOut && $setup.onMouseOut(...args)),
            },
            vue.toHandlers(
                ...
                default: vue.withCtx(() => [
                                ...
                                vue.createElementBlock(
                                  "div",
                                  {
                                    ...
                                    style: vue.normalizeStyle(
                                      $setup.mobileItemBackgroundStyle
                                    ),
                                  },
                                  null,
                                  4 /* STYLE */
                  ...
                  vue.createElementVNode(
                    "div",
                    {
                      ...
                      style: vue.normalizeStyle(
                        $setup.isMobileItem && $setup.mobileItemStyle
                      ),
                    },
                    [
                      vue.createElementVNode(
                        ...
                        ? (vue.openBlock(),
                          vue.createElementBlock(
                            "div",
                            {
                              ...
                              class: vue.normalizeClass([
                                "vsm--child",
                                $setup.isMobileItem && "vsm--child_mobile",
                              ]),
                              style: vue.normalizeStyle(
                                $setup.isMobileItem &&
                                  $setup.mobileItemDropdownStyle
                              ),
                            },
                            [
          ...
          vue.createElementVNode(
            "div",
            {
              ...
              onScroll:
                _cache[0] ||
                (_cache[0] = (...args) =>
                  $setup.onScroll && $setup.onScroll(...args)),
            },
            [vue.renderSlot(_ctx.$slots, "default")],
          ...
          vue.createElementVNode(
            "div",
            {
              ...
              onMousedown:
                _cache[2] ||
                (_cache[2] = (...args) =>
                  $setup.onClick && $setup.onClick(...args)),
            },
            [
              vue.createElementVNode(
                "div",
                {
                  ...
                  onMousedown:
                    _cache[1] ||
                    (_cache[1] = (...args) =>
                      $setup.onMouseDown && $setup.onMouseDown(...args)),
                },
                null,
                544 /* HYDRATE_EVENTS, NEED_PATCH */
              ),
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_sidebar_menu_item =
      vue.resolveComponent("sidebar-menu-item");
    const _component_sidebar_menu_scroll = vue.resolveComponent(
      "sidebar-menu-scroll"
    );
              ...
              vue.createElementVNode(
                ...
                [
                  ...
                  vue.createElementBlock(
                    vue.Fragment,
                    null,
                    vue.renderList($setup.computedMenu, (item) => {
                      return (
                        vue.openBlock(),
                        vue.createBlock(
                          _component_sidebar_menu_item,
              ...
              vue.createElementBlock(
                "button",
                {
                  ...
                  onClick:
                    _cache[0] ||
                    (_cache[0] = (...args) =>
                      $setup.onToggleClick && $setup.onToggleClick(...args)),
                },
                [
